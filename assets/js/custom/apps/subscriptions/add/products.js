...
var KTSubscriptionsProducts = function () {
    ...
    var addPosition = function() {
        ...
        const closeButton = modalEl.querySelector('#kt_modal_add_positions_close');
        const cancelButton = modalEl.querySelector('#kt_modal_add_positions_cancel');
        const submitButton = modalEl.querySelector('#kt_modal_add_positions_submit');
    ...
    return {
        init: function () {
            modalEl = document.getElementById('kt_modal_add_positions');
